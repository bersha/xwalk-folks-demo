...
## Environments
- Preview: https://main--xwalk-folks-demo--bersha.aem.page/
- Live: https://main--xwalk-folks-demo--bersha.aem.live/
...
1. Open the `xwalk-folks-demo` directory in your favorite IDE and start coding :)
